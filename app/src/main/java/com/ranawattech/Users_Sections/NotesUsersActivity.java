...
import com.ranawattech.collagenotes.databinding.ActivityNotesUsersBinding;
...
public class NotesUsersActivity extends AppCompatActivity {
    ...
    private com.ranawattech.collagenotes.Adapter_Users.AdapterNotes adapterNotes;
        ...
        reference.orderByChild("subjectId").equalTo(subjectId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapterNotes= new com.ranawattech.collagenotes.Adapter_Users.AdapterNotes(NotesUsersActivity.this,notesArrayList);
