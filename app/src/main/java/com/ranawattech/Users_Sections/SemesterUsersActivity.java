...
import com.ranawattech.collagenotes.databinding.ActivitySemesterUsersBinding;
...
public class SemesterUsersActivity extends AppCompatActivity {
    ...
    //adapter
    private com.ranawattech.collagenotes.Adapter_Users.AdapterSemester adapterSemester;
        ...
        reference.orderByChild("courseId").equalTo(courseId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup Adapter
                        adapterSemester = new com.ranawattech.collagenotes.Adapter_Users.AdapterSemester(SemesterUsersActivity.this,semesterArrayList);
