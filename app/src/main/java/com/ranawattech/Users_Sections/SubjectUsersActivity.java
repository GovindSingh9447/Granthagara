...
import com.ranawattech.collagenotes.databinding.ActivitySubjectUsersBinding;
...
public class SubjectUsersActivity extends AppCompatActivity {
    ...
    //adapter
    private com.ranawattech.collagenotes.Adapter_Users.AdapterSubject adapterSubject;
        ...
        reference.orderByChild("semesterId").equalTo(semesterId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup Adapter
                        adapterSubject = new com.ranawattech.collagenotes.Adapter_Users.AdapterSubject(SubjectUsersActivity.this,subjectArrayList);
