...
import com.ranawattech.collagenotes.databinding.ActivitySemesterAdminBinding;
...
public class SemesterAdminActivity extends AppCompatActivity {
    ...
    //view binding
    private ActivitySemesterAdminBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivitySemesterAdminBinding.inflate(getLayoutInflater());
        ...
        reference.orderByChild("courseId").equalTo(courseId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup Adapter
                        adapterSemester =new AdapterSemester(SemesterAdminActivity.this,semesterArrayList);
