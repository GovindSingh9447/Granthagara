...
public class UploadEntranceActivity extends AppCompatActivity {
    ...
    private ArrayList<String> entranceTitleArrayList , entranceIdArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.gobackbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(UploadEntranceActivity.this, UserDashboard.class);
    ...
    private void interviewPickDialog() {
        ...
        String[] interviewArray = new String[entranceTitleArrayList.size()];
        for(int i=0;i<entranceTitleArrayList.size();i++){
            interviewArray[i]=entranceTitleArrayList.get(i);
        }
        ...
        builder.setTitle("Pick Interview Section")
                .setItems(interviewArray, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        selectInterviewTitle=entranceTitleArrayList.get(which);
                        selectInterviewId=entranceIdArrayList.get(which);
    ...
    private void loadInterview() {
        entranceIdArrayList=new ArrayList<>();
        entranceTitleArrayList=new ArrayList<>();

        //db ref to load interview
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference("EntrancesSection");
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {

                //clear before adding data
                entranceIdArrayList.clear();
                entranceTitleArrayList.clear();

                for (DataSnapshot ds: snapshot.getChildren()){
                    String interviewId=""+ds.child("id").getValue();
                    String interviewTitle=""+ds.child("title").getValue();

                    entranceIdArrayList.add(interviewId);
                    entranceTitleArrayList.add(interviewTitle);
                }
            }
    ...
    private void validationNotes() {
        ...
        if (TextUtils.isEmpty(notesName)){
            ...
            Toast.makeText(this, "Pick Entrance Group....", Toast.LENGTH_SHORT).show();
        }
    ...
    private void addBookFirebase() {
        ...
        //path
        String filepathAndName="Entrances_Notes/"+"Book_Preview/"+book+timestamp;
        //storage reference
        ...
        storageReference.putFile(filePath)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(UploadEntranceActivity.this, "NOTES upload failed due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        reference.child(""+book+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(UploadEntranceActivity.this, "Notes is Uploaded Successfully....", Toast.LENGTH_SHORT).show();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(UploadEntranceActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void uploadToInterviewStorage() {
        ...
        String filepathAndName ="Entrances_Notes/"+select_booksnames+"/"+notesN+timestamp;
    ...
    private void addpdfFirebase(String uploadeNotesUrl, long timestamp) {
        ...
        //upload to fb db
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference("Entrances_Notes");
