...
import com.ranawattech.Animes.AnimesActivity;
import com.ranawattech.Animes.AnimesAdapter.AnimesAdapter;
import com.ranawattech.Animes.AnimesModel.AnimesModel;
import com.ranawattech.Hindi_Upnayas.Adapter.HinUpnAdapter;
import com.ranawattech.Hindi_Upnayas.HindiUpnayasActivity;
import com.ranawattech.Hindi_Upnayas.Model.HinUpnModel;
import com.ranawattech.Interview.InterviewActivity;
...
import com.ranawattech.Interview.UploadInterviewActivity;
import com.ranawattech.School.ClassActivity;
import com.ranawattech.School.SchoolAdapter.ClassAdapter;
import com.ranawattech.School.SchoolModel.ClassModel;
import com.ranawattech.School.UploadSchoolDataActivity;
import com.ranawattech.Users_Sections.UserPolicyActivity;
import com.ranawattech.Users_Sections.UserUploadActivity;
import com.ranawattech.collagenotes.Model.ModelCollage;
import com.ranawattech.collagenotes.databinding.ActivityUserDashboardBinding;
import com.ranawattech.entrance.EntranceActivity;
import com.ranawattech.entrance.UploadEntranceActivity;
...
public class UserDashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      binding.profile.setOnClickListener(new View.OnClickListener() {
        ...
        //Entrance
        binding.entranceUpload.setOnClickListener(v->{
            Intent intent=new Intent(UserDashboard.this, UploadEntranceActivity.class);
            startActivity(intent);
            finish();
        });

        binding.entrance.setOnClickListener(v->{
            Intent intent=new Intent(UserDashboard.this, EntranceActivity.class);
            startActivity(intent);
            finish();
        });
    ...
    private void animateNavigationDrawer() {
        ...
        drawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                ...
                final int diffScaledOffset = (int) (slideOffset * (1 - END_SCALE));
                final int offsetScale = 1 - diffScaledOffset;
    ...
    private void loadCollages() {
        ...
        reference.limitToFirst(5).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCollage = new com.ranawattech.collagenotes.Adapter_Users.AdapterCollage(UserDashboard.this, collageArrayList);
