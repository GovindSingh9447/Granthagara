...
public class FilterUsersSemester extends Filter {
    ...
    com.ranawattech.collagenotes.Adapter_Users.AdapterSemester adapterSemester;

    //constructor


    public FilterUsersSemester(ArrayList<ModelSemester> filterList, com.ranawattech.collagenotes.Adapter_Users.AdapterSemester adapterSemester) {
