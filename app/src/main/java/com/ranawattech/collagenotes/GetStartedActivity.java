...
public class GetStartedActivity extends AppCompatActivity {
    com.ranawattech.collagenotes.databinding.ActivityGetStartedBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding= com.ranawattech.collagenotes.databinding.ActivityGetStartedBinding.inflate(getLayoutInflater());
