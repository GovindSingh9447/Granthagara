...
public class FilterUsersCourse extends Filter {
    ...
    com.ranawat.collagenotes.Adapter_Users.AdapterCourse adapterCourse;

    //constructor


    public FilterUsersCourse(ArrayList<ModelCourse> filterList, com.ranawat.collagenotes.Adapter_Users.AdapterCourse adapterCourse) {
