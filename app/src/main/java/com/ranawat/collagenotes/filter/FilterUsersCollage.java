...
public class FilterUsersCollage extends Filter {
    ...
    com.ranawat.collagenotes.Adapter_Users.AdapterCollage adapterCollage;

    //constructor


    public FilterUsersCollage(ArrayList<ModelCollage> filterList, com.ranawat.collagenotes.Adapter_Users.AdapterCollage adapterCollage) {
